    ...
    moderadas: [
      {
        ...
        imagen: "https://images.unsplash.com/photo-1582037928785-98f0c6d424e3?q=80&w=1374&auto=format&fit=crop",
        horario: "10:00 AM - 9:00 PM",
        rango_precio: "$$ - $$$",
      ...
      },
      {
        ...
        imagen: "https://images.unsplash.com/photo-1581316009585-5ff9976c965e?q=80&w=1470&auto=format&fit=crop",
        horario: "10:00 AM - 9:00 PM",
        rango_precio: "$$ - $$$",
    ...
    <div className="pt-20 pb-12 bg-miami-sand min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative h-80 md:h-96 lg:h-[500px] rounded-xl overflow-hidden mb-12">
          <img 
            src="https://images.unsplash.com/photo-1481437156560-3205f6a55735?q=80&w=1470&auto=format&fit=crop" 
